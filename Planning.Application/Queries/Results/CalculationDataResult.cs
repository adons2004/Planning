...
public class CalculationDataResult
{
    public CalculationDataResult()
    {
        
    }
    public CalculationDataResult(CalculatableSku sku)
    {
        Uid = sku.Uid;
        Name = sku.Name;
        ...
        Children = sku.Children.Select(c => new CalculationDataResult(c)).ToArray();
    }
    
    public Guid Uid { get; set; }
    public string Name { get; set; }
    public CalculationDataResult[] Children { get; set; }
