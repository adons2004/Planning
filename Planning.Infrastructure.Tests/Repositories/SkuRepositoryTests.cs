...
public class SkuRepositoryTests : IClassFixture<InfrastructureTestHost>
{
    ...
    {
        // act
        var skus = await _testHost.AggregateRepository.Get([], CancellationToken.None);
    ...
    public async Task GetByUidSuccessful()
    {
        ...
        // act
        var sku = await _testHost.AggregateRepository.Get(uid, CancellationToken.None);
    ...
    public async Task UpdateSuccessful()
    {
        ...
        _testHost.AggregateRepository.Update(sku);
        _testHost.AggregateRepository.SaveChanges();
        
        // assert
        var actualSku = await _testHost.AggregateRepository.Get(uid, CancellationToken.None);
